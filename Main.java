...
public class Main {
    ...
    public static void main(String[] args)
    {
        ...
        Parrot parrot3 = new Parrot(10);
        Parrot parrot4 = new Parrot(true);

        Parrot parrot2 = new Parrot();
        System.out.println(parrot1.name + " " + parrot2.name);
        ...
        System.out.println(parrot1.name + " " + parrot2.name + " " + Parrot.name);
